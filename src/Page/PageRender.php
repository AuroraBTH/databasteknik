...
class PageRender implements PageRenderInterface, InjectionAwareInterface
{
    ...
    public function renderPage($data = null, $status = 200)
    {
        ...
        $data["scripts"] = ["../vendor/twbs/bootstrap/assets/js/vendor/jquery-slim.min.js", "../vendor/twbs/bootstrap/assets/js/vendor/popper.min.js", "../vendor/twbs/bootstrap/dist/js/bootstrap.min.js"];
